...
public class AvoidSubBezier extends OpMode {
    Follower follower;
    Pose beginPos = new Pose(AvoidSubParameters.startX, AvoidSubParameters.startY, AvoidSubParameters.startAngle);
    Pose targetPos = new Pose(AvoidSubParameters.endX, AvoidSubParameters.endY, AvoidSubParameters.endAngle);
