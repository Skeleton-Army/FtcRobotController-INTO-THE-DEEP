...
public class AutoApplication extends AutoOpMode {
    ...
    public void onStart() {
        ...
        camCV.configureWebcam(new SampleColor[] { SampleColor.YELLOW,
                alliance == Alliance.RED ? SampleColor.RED : SampleColor.BLUE });
                ...
                new ParallelAction(
                        ...
                        drive.actionBuilder(drive.pose)
                                ...
                                .splineToLinearHeading(
                                        new Pose2d(startPose.position.x, -37, Math.toRadians(95 + angleCompensation)),
                                        Math.PI / 2, null,
                                        new ProfileAccelConstraint(-1000000, hangedSpecimens == 1 ? 60 : 150))
                                .splineToLinearHeading(
                                        new Pose2d(startPose.position.x, hangedSpecimens == 5 ? -30 : -32.5,
                                                Math.toRadians(95 + angleCompensation)),
                                        Math.PI / 2, null,
                                        new ProfileAccelConstraint(-60, hangedSpecimens == 1 ? 60 : 150))
                                .build()));
        ...
        runBlocking(
                new ParallelAction(
                        drive.actionBuilder(drive.pose)
                                ...
                                .splineToLinearHeading(new Pose2d(27, -63.2, Math.toRadians(95 + angleCompensation)),
                                        Math.toRadians(270), null, new ProfileAccelConstraint(-60, 150))
                                .build(),
                        new SequentialAction(
                                specimenArm.grabOpen(),
        ...
        runBlocking(
                new SequentialAction(
                        drive.actionBuilder(drive.pose)
                                ...
                                .splineToLinearHeading(new Pose2d(48.5, -42, Math.toRadians(95)), 0, null,
                                        new ProfileAccelConstraint(-25, 100))
                                .build(),
                        new SequentialAction(
                                intake.openClaw(),
                                intake.extendWrist(),
    ...
    private void putInBasket() {
        ...
        if (collectedSamples == 0) {
            runBlocking(
                    new ParallelAction(
                            drive.actionBuilder(drive.pose)
                                    ...
                                    .splineToLinearHeading(new Pose2d(-55, -55, Math.toRadians(45)),
                                            Math.toRadians(225), null, new ProfileAccelConstraint(-100, 200))
                                    .build(),
                            dunkSequence));
            ...
            runBlocking(
                    new ParallelAction(
                            drive.actionBuilder(drive.pose)
                                    ...
                                    .splineToLinearHeading(
                                            new Pose2d(-51 + xCompensation, -54 - yCompensation,
                                                    Math.toRadians(45 + angleCompensation)),
                                            Math.toRadians(225), null, new ProfileAccelConstraint(-80, 200))
                                    .build(),
                            new SequentialAction(
                                    intakeRetract,
                                    dunkSequence)));
            ...
            runBlocking(
                    new ParallelAction(
                            drive.actionBuilder(drive.pose)
                                    .splineToLinearHeading(new Pose2d(-56, -56, Math.toRadians(45)),
                                            Math.toRadians(225))
                                    .build(),
                            new SequentialAction(
                                    intakeRetract,
        ...
        if (collectedSamples < 6) {
            addConditionalTransition(collectedSamples < 3, State.COLLECT_YELLOW_SAMPLE,
                    State.COLLECT_ADDITIONAL_SAMPLE);
        } else {
            addTransition(State.PARK);
        }
    }
    ...
    private void sampleFromSubmersible() {
        ...
        runBlocking(
                drive.actionBuilder(drive.pose)
                        .splineTo(new Vector2d(-32 - xCompensation, -5), Math.toRadians(0), null,
                                new ProfileAccelConstraint(-100, 200))
                        .build());
        ...
        switch (strategy) {
            case SPECIMENS:
                ...
                runBlocking(
                        drive.actionBuilder(drive.pose)
                                .setTangent(Math.toRadians(270))
                                .splineToConstantHeading(new Vector2d(50, startPose.position.y), Math.toRadians(-45),
                                        null, new ProfileAccelConstraint(-100, 200))
                                .build());
            ...
            case BASKET:
                ...
                if (drive.pose.position.x < -35) {
                    runBlocking(
                            drive.actionBuilder(drive.pose)
                                    .splineTo(new Vector2d(-27, -9), Math.toRadians(0), null,
                                            new ProfileAccelConstraint(-100, 200))
                                    .build());
                }
